        ...
        $(document).ready(function () {
            table = $('#stockTable').DataTable({
                ...
                columns: [
                    { data: 'name' },
                    {
                        data: 'picture_file_path',
                        render: function(data) {
                            if (data) {
                                return `<img src="/storage/${data}" class="w-10 h-10 rounded-lg object-cover border border-gray-200" alt="Stock item">`;
                            }
                            // Placeholder SVG
                            return `
                                <div class="w-10 h-10 rounded-lg bg-gray-100 flex items-center justify-center border border-gray-200 text-gray-400">
